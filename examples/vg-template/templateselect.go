...
func (c *Templateselect) NumberOfOptions() int {
	return c.numberOfOptions
}

// Random returns the ith randon number from the list
func (c *Templateselect) Random(i int) int {
...
// This "value" attribute of the option tag is set dynamically in the Templateselect.vugu file.
...
func (c *Templateselect) Change(e vugu.DOMEvent) {
	e.PreventDefault()
